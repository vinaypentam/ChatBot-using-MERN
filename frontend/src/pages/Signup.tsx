    ...
    <div>
      <Box display={'flex'} width={"100%"} height={"100%"}>
        ...
        <Box display={"flex"} flex={{md: 0.5, xs: 1}} padding={2} mt={16} alignItems={"center"} justifyContent={"center"} m="auto">
          <form style={{margin: "auto", padding: "10px", boxShadow: "20px 20px 10px black"}} onSubmit={handleSignup}>
            <Box sx={{justifyContent:"center", flexDirection: "column", display: "flex", gap: "10px", mx: "auto"}}>
              <Typography variant='h4' fontWeight={600} textAlign={"center"} padding={2} letterSpacing={"3px"}>
                Sign up
              </Typography>
              <TextField type='text' name='name' label="Name" InputLabelProps={{style:{color: "white", fontWeight:"600", letterSpacing:"2px"}}} inputProps={{style:{width:"400px", borderRadius:"10px", fontSize: 20, color: "white",}}}/>  
